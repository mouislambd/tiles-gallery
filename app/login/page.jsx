        ...
        <div className="min-h-screen flex items-center justify-center px-4"
            ...
            <div className="w-full max-w-md rounded-2xl p-8"
                ...
                <form onSubmit={handleLogin}>
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            required
                            className="w-full px-4 py-3 rounded-lg text-white outline-none text-sm"
                    ...
                    <button type="submit" disabled={loading}
                        ...
                        style={{ background: '#C8A96E', color: '#111827', opacity: loading ? 0.7 : 1 }}>
                ...
                <button onClick={handleGoogle}
                    className="w-full py-3 rounded-lg text-sm font-medium flex items-center justify-center gap-3"
                ...
                <p className="text-center text-sm text-gray-500 mt-6">
                    No account?{' '}
                    <Link href="/register" style={{ color: '#C8A96E' }}>Register</Link>
                </p>
